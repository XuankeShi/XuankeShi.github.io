...
## [SenseNova-Vision：视觉即统一多模态生成](https://arxiv.org/abs/2607.06560)

**SenseNova-Vision** 将不同的计算机视觉任务统一表述在多模态模型原生的文本与图像生成空间中。无需针对具体任务设计预测头，单一模型即可支持目标检测、OCR、关键点估计、图像分割、深度估计、表面法线预测、点图生成与相机位姿估计等任务。

**角色：** 核心贡献者 · 2026<br>
[论文](https://arxiv.org/abs/2607.06560) · [代码](https://github.com/OpenSenseNova/SenseNova-Vision)

<div align="center">
  <img src="/images/paper/sensenova-vision.webp" alt="SenseNova-Vision 模型概览">
</div>
